...
<div id="myBody">
	<main class="mycontainer">
		<video src="../../images/aboutPage/ArmorOfBerserk/omoribg1.mp4" muted loop autoplay></video>
		<section class="personalInfo_armor">
			...
			<p id="description">Hi, my name is Simone, I study computer science at the Universita' della Calabria (CS).
				...
				I am most fond of in the field of TV series, manga and video games.
				I highly recommend you to recover these works, you will not regret it!</p>
		</section>

		<div class="favorite_things_armor">
