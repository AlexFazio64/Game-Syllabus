...
<head>
    ...
    <link rel="stylesheet" href="../../css/profileListStyle.css">
...
<c:if test="${stateOperation!=null}">
    <script>
        swal("Success!", "Game removed to your list", "success");
    </script>
</c:if>
...
/*    function populateList(game) {
/!*    console.log(game);
    console.log(typeof game);
    console.log(game.length);
        for(var i = 0; i < game.length; i++){
            console.log("ECCOMI");
            var div_gioco = document.createElement('div');
            document.getElementById("dio").appendChild(div_gioco);
        }*!/
